...
#include ..\\..\\Shaders\\mandelBoxTunnel.c
...
void main()
{
    ...
    Sphere sphere;
    sphere.center = ubo.playerPos;
    sphere.radius = ubo.playerRadius;
    sphere.color = ubo.playerColor;
    ...
    outColor = vec4(getColor(distanceToSurface, rayOrigin, rayDir), 1.);
}
