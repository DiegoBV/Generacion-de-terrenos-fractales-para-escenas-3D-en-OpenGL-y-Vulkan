...
void VulkanManager::createTextureImage()
{
	...
	stbi_uc* pixels = stbi_load("..\\Assets\\Models\\nanosuit\\helmet_showroom_ddn.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
VkImageView VulkanManager::createImageView(VkImage image, VkFormat format)
{
